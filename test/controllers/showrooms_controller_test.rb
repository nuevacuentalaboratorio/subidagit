...
class ShowroomsControllerTest < ActionController::TestCase
  ...
  test "should create showroom" do
    assert_difference('Showroom.count') do
      post :create, showroom: { direccion: @showroom.direccion, horario: @showroom.horario, modulo: @showroom.modulo, telefono: @showroom.telefono }
    end
  ...
  test "should update showroom" do
    patch :update, id: @showroom, showroom: { direccion: @showroom.direccion, horario: @showroom.horario, modulo: @showroom.modulo, telefono: @showroom.telefono }
    assert_redirected_to showroom_path(assigns(:showroom))
  end
